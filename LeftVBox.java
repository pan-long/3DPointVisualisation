...
class LeftVBox extends VBox{
    ...
    private CheckBox setOriginCheckBox = new CheckBox("Set Origin to Center Of Mass");
	...
	public LeftVBox(){
        ...
        setOriginHBox.getChildren().addAll(x, xTextField, y, yTextField, z, zTextField, updateButton);
        fileHbox.getChildren().addAll(openButton, fileNameLabel);
        getChildren().addAll(title, cameraDistanceLabel, cameraDistanceSlider, fieldOfViewLabel, fieldOfViewSlider, 
            sphereLabel, sphereSlider, originLabel, setOriginHBox, setOriginCheckBox, axesCheckBox, fileHbox, buildButton);
	}
